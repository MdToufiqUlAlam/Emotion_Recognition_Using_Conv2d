...
def main():
    ...
    st.title("Emotion Recognition Using Conv2d and Data Augmentation")
    activiteis = ["Home", "Webcam Face Detection", "About"]
    choice = st.sidebar.selectbox("Select Activity", activiteis)
    st.sidebar.markdown("Your last emotion feedback. Feel free to talk with the chatbot!")
    ...
    if choice == "Home":
        st.write("This application has two key functionalities:")
        st.write("1. Real-time face emotion recognition.")
        st.write("2. Feedback of your last emotion and chat with the chatBot.")
        ...
        st.markdown(
            "This application is developed by Md. Toufiq-Ul-Alam and Nusrat Jahan Surovi using Streamlit Framework, OpenCV, "
        ...
        st.markdown("If you have any suggestions or want to comment, please write an email to "
                    "toufiq180020@diit.edu.bd or nusrat180004@diit.edu.bd")
    else:
        pass
